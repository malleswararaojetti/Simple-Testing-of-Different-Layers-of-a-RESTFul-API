...
3. Navigate to maincourse_java_jfse_mc04_testing_different_layers_of_spring_boot_exercise folder

    `cd maincourse_java_jfse_mc04_testing_different_layers_of_spring_boot_exercise`
